(function (root, factory) {
  ...
  function SilkApp$composable(content, $composer, $changed) {
    ...
    $composer_0 = $composer_0.w12(766681329);
    ...
    if (!(($dirty & 11) === 2) ? true : !$composer_0.n11()) {
      ...
      if (false ? true : tmp0_let === Companion_getInstance().rw_1) {
        ...
        tmp1_cache.k13(Unit_getInstance());
      ...
      var tmp2_cache = $composer_2.fv(dispatchReceiver);
      var tmp$ret$6;
      // Inline function 'kotlin.let' call
      ...
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      var tmp_2;
      if (tmp2_cache ? true : tmp0_let_0 === Companion_getInstance().rw_1) {
        var tmp$ret$4;
    ...
    if (tmp0_safe_receiver === null)
      ...
      tmp0_safe_receiver.w16(SilkApp$composable$lambda_1(content, $changed));
    }
  }
  ...
  function SilkApp$composable$lambda_0($content, $$dirty) {
    return function ($composer, $changed) {
      ...
      if (!(($changed & 11) === 2) ? true : !$composer_0.n11()) {
        ...
        $composer_2.h11(-168645675);
        sourceInformation($composer_2, 'CC(Style$composable)');
        Style$composable(null, tmp2_Style$composable.o1v(), $composer_2, 0, 1);
        $composer_2.i11();
  ...
  function Image$composable(src, desc, modifier, autoPrefix, variant, $composer, $changed, $default) {
    ...
    var $composer_0 = $composer;
    $composer_0 = $composer_0.w12(34210657);
    ...
    if (!(($default & 2) === 0))
      ...
      $dirty = $dirty | ($composer_0.fv(desc_0._v) ? 32 : 16);
    if (!(($default & 4) === 0))
      $dirty = $dirty | 384;
    ...
    if (!(($default & 8) === 0))
      ...
      $dirty = $dirty | ($composer_0.o12(autoPrefix_0._v) ? 2048 : 1024);
    if (!(($default & 16) === 0))
      $dirty = $dirty | 24576;
    else if (($changed & 57344) === 0)
      $dirty = $dirty | ($composer_0.fv(variant_0._v) ? 16384 : 8192);
    if (!(($dirty & 46811) === 9362) ? true : !$composer_0.n11()) {
      ...
      Img$composable(prependIf(Companion_getInstance_1(), autoPrefix_0._v, src), desc_0._v, toAttrs(toModifier$composable(get_ImageStyle(), [variant_0._v], $composer_0, 0).w25(modifier_0._v)), $composer_0, 112 & $dirty, 0);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
    ...
    if (tmp0_safe_receiver === null)
      ...
      tmp0_safe_receiver.w16(Image$composable$lambda(src, desc_0, modifier_0, autoPrefix_0, variant_0, $changed, $default));
    }
  }
  ...
  function Link$composable(path, text, modifier, variant, openInternalLinksStrategy, openExternalLinksStrategy, autoPrefix, ref, $composer, $changed, $default) {
    ...
    var ref_0 = {_v: ref};
    var $composer_0 = $composer;
    $composer_0 = $composer_0.w12(1950033137);
    ...
    if (!(($default & 64) === 0))
      ...
      $dirty = $dirty | ($composer_0.o12(autoPrefix_0._v) ? 1048576 : 524288);
    if (!(($default & 128) === 0))
      $dirty = $dirty | 12582912;
    else if (($changed & 29360128) === 0)
      $dirty = $dirty | ($composer_0.fv(ref_0._v) ? 8388608 : 4194304);
    if (!(($dirty & 23967451) === 4793490) ? true : !$composer_0.n11()) {
      if (!(($default & 2) === 0)) {
        text_0._v = null;
      }
      if (!(($default & 4) === 0)) {
    ...
    if (tmp0_safe_receiver === null)
      ...
      tmp0_safe_receiver.w16(Link$composable$lambda_0(path, text_0, modifier_0, variant_0, openInternalLinksStrategy_0, openExternalLinksStrategy_0, autoPrefix_0, ref_0, $changed, $default));
    }
  }
  function Link$composable_0(path, modifier, variant, openInternalLinksStrategy, openExternalLinksStrategy, autoPrefix, ref, content, $composer, $changed, $default) {
    ...
    var ref_0 = {_v: ref};
    var $composer_0 = $composer;
    $composer_0 = $composer_0.w12(231966754);
    ...
    if (!(($default & 32) === 0))
      ...
      $dirty = $dirty | ($composer_0.o12(autoPrefix_0._v) ? 131072 : 65536);
    if (!(($default & 64) === 0))
      $dirty = $dirty | 1572864;
    else if (($changed & 3670016) === 0)
    ...
    if (!(($default & 128) === 0))
      ...
      $dirty = $dirty | ($composer_0.n12(content) ? 8388608 : 4194304);
    if (!(($dirty & 23967451) === 4793490) ? true : !$composer_0.n11()) {
      if (!(($default & 2) === 0)) {
        modifier_0._v = Companion_getInstance_0();
      }
      ...
      var tmp = toAttrs(toModifier$composable(get_LinkStyle(), [variant_0._v], $composer_0, 0).w25(modifier_0._v));
    ...
    if (tmp0_safe_receiver === null)
      ...
      tmp0_safe_receiver.w16(Link$composable$lambda_2(path, modifier_0, variant_0, openInternalLinksStrategy_0, openExternalLinksStrategy_0, autoPrefix_0, ref_0, content, $changed, $default));
    }
  }
